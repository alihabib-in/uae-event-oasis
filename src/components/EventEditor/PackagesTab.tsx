      ...
      <div className="space-y-6">
        <div className="border rounded-lg p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <FormLabel htmlFor="packageName" className="text-gray-800">Package Name</FormLabel>
              <Input 
                id="packageName"
            ...
            <div>
              <FormLabel htmlFor="packagePrice" className="text-gray-800">Price (AED)</FormLabel>
              <Input 
                id="packagePrice"
                type="number"
            ...
            <div className="md:col-span-3">
              <FormLabel htmlFor="packageDescription" className="text-gray-800">Description</FormLabel>
              <Textarea 
